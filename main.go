...
var realTimeYears = flag.Float64("realTime", 100, "Time to simulate in years")
var simulationTimeSeconds = flag.Float64("simulationDuration", 120, "Simulation duration in seconds")
var frameRate = flag.Int("fps", 120, "Number of frames per second")
...
func main() {
	...
	if *render {
		...
		// Plotten der Frames mit gnuplot
		...
		// Zusammenfügen der Frames zum Video mit ffmpeg
...
// Beschleunigung auf den Planeten, wenn dieser am Ort r zum angegebenen Zeitschritt ist.
...
// Berechnet den angegebenen Zeitschritt
